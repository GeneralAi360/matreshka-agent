...
> Статус: собрана development preview версии `0.1.1`. Архитектура сверена с официальными рекомендациями OpenAI, Anthropic, Cursor, Google Antigravity и Agent Skills на 16 июля 2026 года. Все девять навыков и четыре платформенных манифеста входят в пакет.
